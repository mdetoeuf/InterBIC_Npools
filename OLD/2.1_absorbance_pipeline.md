...
```
    ...
    # A tibble: 34 × 9
     ...
     1 H          6 H6      NO2_TDN_19_H6  NO2   NO2_TDN_19 Ur_K2SO4_200…       0   
     2 H          7 H7      NO2_TDN_19_H7  NO2   NO2_TDN_19 Ur_K2SO4_200…       0   
     3 H          9 H9      NO2_TDN_19_H9  NO2   NO2_TDN_19 Ur_K2SO4_5_C…       0   
     4 H          1 H1      NO3_TDN_09_H1  NO3   NO3_TDN_09 Std                 2.94
     5 H          1 H1      NO3_TDN_10_H1  NO3   NO3_TDN_10 Std                 2.80
     6 H          1 H1      NO3_TDN_11_H1  NO3   NO3_TDN_11 Std                 2.79
     7 H          1 H1      NO3_TDN_12_H1  NO3   NO3_TDN_12 Std                 2.86
     8 H          1 H1      NO3_TDN_13_H1  NO3   NO3_TDN_13 Std                 2.74
     9 H          1 H1      NO3_TDN_14_H1  NO3   NO3_TDN_14 Std                 2.75
    10 H          1 H1      NO3_TDN_15_H1  NO3   NO3_TDN_15 Std                 2.62
    # ℹ 24 more rows
...
```
    ...
    Warning in qc4_std_blanc_variation(N_all_plate, nb_std = 2): There are 388 standard curves in this data set, thus in theory also 388 wells containing the blanc for those curves. 
    Of those 388, 63 are untrusted (see comments in the function definition for details on untrusted wells). Try ?qc4_std_blanc_variation().  
    We are thus a priori trusting 325 wells out of 388.
...
```
    ...
    [1] "There are 388 standard curves in this data set, thus in theory also 388 wells containing the blanc for those curves. \nOf those 388, 63 are untrusted (see comments in the function definition for details on untrusted wells). Try ?qc4_std_blanc_variation().  \nWe are thus a priori trusting 325 wells out of 388."
...
```
    ...
    Warning in qc6_extr_trusted(QC5, cut_threshold = cut_threshold): From 1740 wells in total for extractant, 12 have been removed because their absorbance value appeared to be an outlier from a within-plate perspective. 
