...
- Should it not be empty, decide what to do: broader range ok? Remove outliers? Should some wells be removed, then re-run the `qc_raw_abs()` on the updated data
:::
...
Now, finally, I decide that I am happy with my standard curves, so I can move on to apply the equations on my data in the next script
