...
The adjusted R-squared is not huge: 0.6, but the p-value is low enough (2.6 e-5)

Significant are: the intercept, the effect of incubation time 3 and 4. In other terms:
...
- There is an effect of
  ...
  - but not of the slope (not surprising considering the plots)
