...
```
    ...
    # A tibble: 158 × 5
     ...
     3 NO3_TDN_38 extr    0.0714   0.00472                   6.61
     ...
     8 NO2_TDN_03 extr    0.0365   0.00141                   3.87
     9 NO2_2F6_1  extr    0.0368   0.00139                   3.78
    10 NO3_TDN_07 extr    0.0921   0.00314                   3.40
    # ℹ 148 more rows
...
> >
> > - <u>**Make sure to deal appropriately with plates that require 2
> >   outliers to be removed**</u> (see example below)
