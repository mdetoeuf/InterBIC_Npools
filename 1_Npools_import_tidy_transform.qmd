...
### 6.2.7 - Export clean data

```{r}
# clean_conc_all <- list(
#   "greenhouse_t2_Nmin_clean" = greenhouse_t2_Nmin_clean,
#   "greenhouse_t2_PMN_clean" = greenhouse_t2_PMN_clean,
#   "Field_t2_Nmin_clean" = Field_t2_Nmin_clean,
#   "field_t2_TDN_clean" = field_t2_TDN_clean,
#   "field_t2_PMN_clean" = field_t2_PMN_clean,
#   "raw_greenhouse_t2_Nmin" = raw_greenhouse_t2_Nmin,
#   "raw_field_t2_Nmin" = raw_field_t2_Nmin
# )
# 
# clean_conc_all |> write_rds("output/data/1_Npools_temp_clean_conc_all.rds")
```

## 6.3 - Per-sample mean

Empty environment and import data

```{r}
# rm(list = ls())
# 
# clean_conc_all <- read_rds("output/data/1_Npools_temp_clean_conc_all.rds")
# 
# greenhouse_t2_Nmin_clean <-   clean_conc_all$greenhouse_t2_Nmin_clean
# greenhouse_t2_PMN_clean <- clean_conc_all$greenhouse_t2_PMN_clean
# Field_t2_Nmin_clean <- clean_conc_all$Field_t2_Nmin_clean
# field_t2_TDN_clean <- clean_conc_all$field_t2_TDN_clean
# field_t2_PMN_clean <- clean_conc_all$field_t2_PMN_clean
```
