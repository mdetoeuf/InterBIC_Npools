...
Once that is done –\> go through another iteration of remove_wells().
...
#** TO BE COMPLETED WITH WELLS TO REMOVE FOR NO3 SUSPICIOUS CURVES *
#*
...
# extract all plates where "something" is not perfect 
lm_table_suspicious_wash1 <- lm_table_wash1 |> 
  filter_out(
    normality_lm_residuals == "Normal" & 
      homoscedasticity_lm_residuals == "Homooscedasticity" &
      lm_p < 0.05)
