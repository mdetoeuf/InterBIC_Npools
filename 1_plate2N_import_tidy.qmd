...
For the slurry test, aw also generate the plate map from a list of samples. First, import it and extract relevant info
...
map_list <- nh4 |> 
  ...
  mutate(
    ...
    plate_id_generic = paste0("PNR_", batch, "_", plate_nb_per_batch),
