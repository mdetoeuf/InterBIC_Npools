...
```
    ...
    # A tibble: 59 × 5
       ...
       <chr>        <chr>     <dbl>      <dbl>                   <dbl>
     1 NO3_TDN_38   extr     0.0714   0.00472                     6.61
     2 NO2_TDN_03   extr     0.0365   0.00141                     3.87
     3 NO3_TDN_07   extr     0.0921   0.00314                     3.40
     4 NO3_TDN_29   extr     0.147    0.00472                     3.22
     5 NO2_TDN_17   extr     0.0384   0.00106                     2.76
     6 NO3_TDN_36_1 extr     0.0708   0.00183                     2.59
     7 NO3_TDN_32   extr     0.133    0.00344                     2.59
     8 NO2_TDN_06   extr     0.0365   0.000926                    2.54
     9 NO3_TDN_04   extr     0.102    0.00253                     2.48
    10 NO3_TDN_25   extr     0.145    0.00329                     2.28
    # ℹ 49 more rows
...
```
    ...
    # A tibble: 6 × 5
      plate_id     map   blank_avg blank_sdev blank_coeff_var_percent
      <chr>        <chr>     <dbl>      <dbl>                   <dbl>
    1 NO2_TDN_03   extr     0.0365    0.00141                    3.87
    2 NO3_TDN_07   extr     0.0921    0.00314                    3.40
    3 NO3_TDN_29   extr     0.147     0.00472                    3.22
    4 NO2_TDN_17   extr     0.0384    0.00106                    2.76
    5 NO3_TDN_36_1 extr     0.0708    0.00183                    2.59
    6 NO3_TDN_32   extr     0.133     0.00344                    2.59
...
```
    ...
    # ℹ 403 more rows
    # ℹ 10 more variables: unique_curve_id <chr>, map <chr>, abs_corrected <dbl>,
    #   std_sp <chr>, std_unit <chr>, sample_dilution <chr>, date <date>,
    #   std_conc <dbl>, blank_sdev <dbl>, blank_coeff_var_percent <dbl>
...
```
    ...
    #   sample_dilution <chr>, date <date>, blank_sdev <dbl>,
...
```
    ...
    # ℹ 10 more variables: unique_curve_id <chr>, map <chr>, abs <dbl>,
    #   std_sp <chr>, std_unit <chr>, sample_dilution <chr>, date <date>,
    #   std_conc <dbl>, blank_sdev <dbl>, blank_coeff_var_percent <dbl>
...
```
    ...
    # A tibble: 20 × 11
     ...
     1 NO2_TDN_01   NO2_TDN_01_col1   NO2    0.259     1.000         1.000 1.19e-12
     2 NO2_TDN_02   NO2_TDN_02_col1   NO2    0.259     1.000         1.000 1.45e-11
     3 NO2_TDN_03   NO2_TDN_03_col1   NO2    0.263     1.000         1.000 4.75e-12
     4 NO2_TDN_04   NO2_TDN_04_col1   NO2    0.262     1.000         1.000 2.80e-12
     5 NO2_TDN_05   NO2_TDN_05_col1   NO2    0.271     1.000         1.000 7.24e-13
     6 NO2_TDN_06   NO2_TDN_06_col1   NO2    0.273     1.000         1.000 6.66e-13
     7 NO2_TDN_07   NO2_TDN_07_col1   NO2    0.258     1.000         1.000 3.96e-12
     8 NO2_TDN_08   NO2_TDN_08_col1   NO2    0.258     1.000         1.000 1.58e-12
     9 NO2_TDN_09   NO2_TDN_09_col1   NO2    0.255     1             1.000 2.56e-14
    10 NO2_TDN_10   NO2_TDN_10_col1   NO2    0.259     1.000         1.000 1.96e-12
    11 NO2_TDN_11   NO2_TDN_11_col1   NO2    0.277     1.000         1.000 8.61e-13
    12 NO2_TDN_12   NO2_TDN_12_col1   NO2    0.276     1.000         1.000 1.01e-12
    13 NO2_TDN_13   NO2_TDN_13_col1   NO2    0.264     1.000         1.000 9.05e-12
    14 NO2_TDN_14   NO2_TDN_14_col1   NO2    0.268     1.000         1.000 2.02e-12
    15 NO2_TDN_15   NO2_TDN_15_col1   NO2    0.266     1.000         1.000 8.04e-13
    16 NO2_TDN_16   NO2_TDN_16_col1   NO2    0.268     1.000         1.000 1.80e-12
    17 NO2_TDN_17   NO2_TDN_17_col1   NO2    0.246     1.000         1.000 4.24e-14
    18 NO2_TDN_18_1 NO2_TDN_18_1_col1 NO2    0.246     1.000         1.000 2.21e-13
    19 NO2_TDN_18_2 NO2_TDN_18_2_col1 NO2    0.246     1.000         1.000 2.21e-13
    20 NO2_TDN_19   NO2_TDN_19_col1   NO2    0.247     1.000         1.000 3   e-12
...
```
    ...
    Joining with `by = join_by(dataset, plate_id, map, abs_corrected, std_sp,
    target_sp, std_unit, adj_r_squared, lm_p)`
...
```
    ...
    # A tibble: 4,485 × 17
    # Rowwise: 
       dataset plate_id   map       abs_corrected std_sp target_sp std_unit   poly_a
       <chr>   <chr>      <chr>             <dbl> <chr>  <chr>     <chr>       <dbl>
     1 TDN     NO3_TDN_01 102_t2_z…         0.459 NO3    N         mg NO3-… -1.52e-5
     2 TDN     NO3_TDN_02 92_t2_z2…         0.471 NO3    N         mg NO3-… -1.74e-5
     3 TDN     NO3_TDN_03 90_t2_z3…         0.434 NO3    N         mg NO3-… -1.49e-5
     4 TDN     NO3_TDN_04 90_t2_z1…         0.433 NO3    N         mg NO3-… -1.31e-5
     5 TDN     NO3_TDN_05 99_t2_z2…         0.460 NO3    N         mg NO3-… -1.32e-5
     6 TDN     NO3_TDN_06 81_t2_z2…         0.438 NO3    N         mg NO3-… -1.07e-5
     7 TDN     NO3_TDN_07 83_t2_z3…         0.380 NO3    N         mg NO3-… -1.60e-5
     8 TDN     NO3_TDN_08 81_t2_z1…         0.375 NO3    N         mg NO3-… -1.39e-5
     9 TDN     NO3_TDN_09 102_t2_z…         0.759 NO3    N         mg NO3-… -2.13e-5
    10 TDN     NO3_TDN_10 92_t2_z2…         0.694 NO3    N         mg NO3-… -1.86e-5
    # ℹ 4,475 more rows
    # ℹ 9 more variables: poly_a_p <dbl>, poly_b <dbl>, poly_b_p <dbl>,
