...
``` r
all_raw_abs_tidy <- read_rds("output/data/1_all_raw_abs_tidy.rds")
all_plate_metadata <- read_rds("output/data/1_all_plate_metadata.rds")
```
...
```
    ...
    Warning in qc_raw_abs(raw_abs_tidy, min_abs = 0.03, max_abs = 4, plot_col_facet = "std_sp", : 3 wells out of 13731 are out of range for absorbance, i.e., not in the set boundaries of [0.03; 4]. 
    See table to identify suspicious wells. 

![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-7-1.png)
...
```
    ...
    Warning in qc_raw_abs(raw_abs_ok, min_abs = 0.03, max_abs = 3, plot_col_facet = "std_sp", : 13 wells out of 13728 are out of range for absorbance, i.e., not in the set boundaries of [0.03; 3]. 
    See table to identify suspicious wells. 

![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-9-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-13-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-13-2.png)
...
```
    ...
    # A tibble: 194 × 5
     ...
     4 NO3_TDN_38 extr     0.0714    0.00472                    6.61
     ...
     9 NO2_TDN_03 extr     0.0365    0.00141                    3.87
    10 NO2_2F6_1  extr     0.0368    0.00139                    3.78
    # ℹ 184 more rows
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-17-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-18-1.png)
...
```
    ...
    3 NO2_TDN_03 extr     0.0365    0.00141                    3.87
    4 NO2_2F6_1  extr     0.0368    0.00139                    3.78
    5 NO3_TDN_07 extr     0.0921    0.00314                    3.40
    6 NO3_TDN_29 extr     0.147     0.00472                    3.22
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-27-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-28-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-28-2.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-28-3.png)
...
Let’s first list wells to remove the H row of NO2 and NH4 std., and also
the following:
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-31-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-33-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-35-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-35-2.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-36-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-38-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-40-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-42-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-43-1.png)
...
![](2_abs_data_QC_files/figure-commonmark/unnamed-chunk-44-1.png)
