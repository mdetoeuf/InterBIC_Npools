...
>   outliers? Should some wells be removed, then re-run the
>   `qc_raw_abs()` on the updated data
...
![](2.1_plate2N_noTDN_abs_to_conc_files/figure-commonmark/unnamed-chunk-11-2.png)
...
move on to apply the equations on my data in the next script
