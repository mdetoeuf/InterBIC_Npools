...
rare: failure to eject liquid with the automated pipette). Although for
NH4_PP1, the wrong A-well is in column 12, so in this case due to
another issue. Nevertheless, the misalignment with the curve is obvious
...
```
    ...
    # A tibble: 165 × 5
       ...
       <chr>      <chr>     <dbl>      <dbl>                   <dbl>
     1 NO2_PP4    extr     0.0494    0.0318                    64.3 
     ...
     7 NO2_PF2    extr     0.0376    0.00177                    4.70
     8 NO3_PP4    extr     0.0872    0.00399                    4.57
     9 NO2_2P6_1  extr     0.0372    0.00158                    4.24
    10 NO2_2F1_1  extr     0.0376    0.00151                    4.00
    # ℹ 155 more rows
...
```
    ...
    # A tibble: 6 × 5
      plate_id   map   blank_avg blank_sdev blank_coeff_var_percent
      <chr>      <chr>     <dbl>      <dbl>                   <dbl>
    1 NO2_PF2    extr     0.0376    0.00177                    4.70
    2 NO3_PP4    extr     0.0872    0.00399                    4.57
    3 NO2_2P6_1  extr     0.0372    0.00158                    4.24
    4 NO2_2F1_1  extr     0.0376    0.00151                    4.00
    5 NO2_2F6_1  extr     0.0368    0.00139                    3.78
    6 NO2_R2R3_1 extr     0.0395    0.00120                    3.03
...
Now we can look at each plot individually. Because there are still 58
plots to review, we will look through them in 4 batches of 15 plots.
...
![](2.1_plate2N_noTDN_abs_to_conc_files/figure-commonmark/unnamed-chunk-27-4.png)
...
```
    ...
    # A tibble: 10 × 15
     ...
     6 H     10     H10     H10_NO2_1F4    Nmint1t2 NO2_1F4  96_t1_z2         0.106 
     7 E     10     E10     E10_NO2_1F4    Nmint1t2 NO2_1F4  96_t1_z2         0.105 
     8 F     10     F10     F10_NO2_1F4    Nmint1t2 NO2_1F4  96_t1_z2         0.104 
     9 G     10     G10     G10_NO2_1F4    Nmint1t2 NO2_1F4  96_t1_z2         0.104 
    10 C     2      C2      C2_NO2_PP4     PMN      NO2_PP4  Pot_Ref_…        0.0929
    # ℹ 7 more variables: std_sp <chr>, std_conc <chr>, std_unit <chr>,
    #   sample_dilution <chr>, date <chr>, blank_sdev <dbl>,
    #   blank_coeff_var_percent <dbl>
...
![](2.1_plate2N_noTDN_abs_to_conc_files/figure-commonmark/unnamed-chunk-31-1.png)
...
![](2.1_plate2N_noTDN_abs_to_conc_files/figure-commonmark/unnamed-chunk-33-1.png)
...
![](2.1_plate2N_noTDN_abs_to_conc_files/figure-commonmark/unnamed-chunk-35-2.png)

We still get 23 “suspicious” curves. But for when we look at the
p-values to reject normality or heteroscedasticity, they are indeed
below 0.05, but it’s also not 10^-5 or something like that. The smallest
p-value (shapiro) is at 0.008.
...
![](2.1_plate2N_noTDN_abs_to_conc_files/figure-commonmark/unnamed-chunk-45-1.png)
