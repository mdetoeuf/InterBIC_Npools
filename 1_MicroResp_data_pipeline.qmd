...
Check it out. It looks the same, but row numbers are a lot less: empty wells were removed
...
!! The plotting / saving chunk is slow and is thus deactivated. Manually run it to save plots again.
